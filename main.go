...
import (
	...
	_ "github.com/MessInWind/zbp_plugin/aatest" // 我的测试插件
...
func init() {
	...
	url := flag.String("u", "ws://127.0.0.1:5800", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "智能机器人", "Set default nickname.")
	...
	markmsg := flag.Bool("m", true, "Don't mark message as read automatically")
